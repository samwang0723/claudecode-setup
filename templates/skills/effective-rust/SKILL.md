...
- `references/services.md` — **Axum service patterns** (handlers, AppError, sqlx repos, auth middleware, config, testing)
- `references/patterns.md` — Ownership, state machines, traits, concurrency, testing
